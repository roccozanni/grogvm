...
GrogVM is an independent reimplementation of the SCUMM v5 engine — the program
...
***The Secret of Monkey Island: Special Edition***, which is still sold today:

- **GOG:** <https://www.gog.com/en/game/the_secret_of_monkey_island_special_edition>
...
editions, auction and second-hand sites exist, but beware of faulty discs and of
illegal copies sold as the real thing.
...
out-of-print book becomes free to reproduce. The copyright in *The Secret of
Monkey Island* is alive and held by its owner; please obtain the game the right
way.

## An independent implementation

GrogVM was written from scratch. The SCUMM file formats and bytecode are not
officially documented; GrogVM's understanding of them was rebuilt from publicly
available reverse-engineering resources and verified against real game data. It is
**not** a port of, and not derived from, ScummVM or any LucasArts code — it is a
separate engine built alongside ScummVM, released under a compatible copyleft
license in the same spirit. Where the project's [format documentation](/docs/scumm/)
draws on external sources, it credits them inline.
...
LucasArts, or any rights holder. These names are used only to describe what the
...
GrogVM hosts and distributes no game assets, and this project is a personal
labour of love with no intent to compete with anyone. If you represent a rights
holder and have a concern, please get in touch at **rocco.zanni@gmail.com** —
messages are read and answered promptly.
