...
> from boot all the way to the end credits in a Chromium-based desktop browser —
> all four parts — with verbs, inventory, dialogue, cutscenes, saves, digital
> sound effects and CD-audio music, and every resource in its files is browsable
> in the explorer. Still ahead: OPL2 synthesis for the few AdLib-only effects,
> Monkey Island 2, and visual polish.
